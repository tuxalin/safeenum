...
namespace util
{
	...
	* Also extends enum with automatic string conversion, iterators(also for non-contigous enumerations), dynamic asserts and enum count.
	*
	...
	*                        eCircle, eSquare, eTriangle);
	*
	* Or you can declare it manually, however extended features will not be available(eg. string conversion, iterators, count):
	* struct Color_def {
